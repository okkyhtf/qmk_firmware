...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
      ...
      KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,   KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   KC_TRNS, KC_DEL,
      ...
      KC_TRNS, KC_TRNS, KC_TRNS,                   RGB_MODE_FORWARD,                   RGB_TOG, KC_TRNS, KC_TRNS
      ),
};
